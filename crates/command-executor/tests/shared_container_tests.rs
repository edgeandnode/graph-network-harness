...
#[test]
fn test_shared_container_first_access() {
    smol::block_on(async {
...
#[test]
fn test_shared_container_second_access() {
    smol::block_on(async {
        ...
        let result2 = executor.execute(&Target::Command, cmd2).await
            .expect("Failed to execute command");
...
#[test]
fn test_shared_container_third_access() {
    smol::block_on(async {
...
#[test]
fn test_shared_container_verify_sharing() {
    smol::block_on(async {
        ...
        let cmd = Command::builder("uptime")
            .arg("-s")
            .build();
