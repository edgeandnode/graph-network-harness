...
const INTEGRATION_TESTS: &str = "stack-runner";
const LOGS: &str = "logs";
...
impl Default for ContainerConfig {
    fn default() -> Self {
        ...
        let log_dir = current_dir
            .join(INTEGRATION_TESTS)
            .join(LOGS)
            .join(CONTAINER_SESSIONS);
...
impl ContainerConfig {
    ...
    pub fn new(
        docker_test_env_path: PathBuf,
        local_network_path: PathBuf,
...
mod tests {
    ...
    fn test_default_config() {
        ...
        assert!(config
            .log_dir
            .to_string_lossy()
            .contains("integration-tests/logs/container-sessions"));
    }
    ...
    fn test_new_config() {
        ...
        assert_eq!(
            config.log_dir,
            project_root.join("integration-tests/logs/container-sessions")
        );
    }
