...
use service_orchestration::{
    Dependency, DependencyOrchestrator, HealthCheck, HealthMonitoringExt, OrchestrationContext,
    ServiceConfig, ServiceInstanceConfig, ServiceTarget, StackConfig,
};
        ...
        ServiceInstanceConfig {
            ...
            orchestration: ServiceConfig {
                ...
                dependencies: vec![Dependency::Service {
                    service: "healthy-service".to_string(),
                }],
                health_check: Some(HealthCheck {
